...
class PerfilUsuario(TimeStampedModel):
    ...
    avatar = models.ImageField(
        ...
        validators=[
            ...
            validate_avatar_size,  # ✅ serializable
        ],
    )
...
class ActividadCronograma(TimeStampedModel):
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="cronograma_actividades")
...
class Inscripcion(TimeStampedModel):
    ...
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="inscripciones")
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="inscripciones_evento")
...
class EvaluacionProyecto(TimeStampedModel):
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="evaluacion_proyectos")
...
class EvaluacionAsignacion(TimeStampedModel):
    ...
    evaluador = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="evaluaciones_asignadas")
...
class Rubrica(TimeStampedModel):
    ...
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="rubricas")
...
class Espacio(TimeStampedModel):
    ...
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="espacios")
...
class Reporte(TimeStampedModel):
    ...
    evento = models.ForeignKey(EVENTO_MODEL, on_delete=models.CASCADE, related_name="reportes")
